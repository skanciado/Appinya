...
@Component({
  selector: "assistencia-popup",
  templateUrl: "assistencia.popup.html",
  styleUrls: ["./assistencia.popup.scss"],
})
export class AssistenciaPopUp extends PaginaLlista implements OnInit {
  ...
  async canviarCerca() {
    ...
    this.iniciarLlista(await this.obtenirElements(), this.actualitar, async (reg) => [], 10);
  }
  /**
