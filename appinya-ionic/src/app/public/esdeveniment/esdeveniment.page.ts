...
export class EsdevenimentPage extends PaginaNavegacio implements OnInit {
  ...
  assistenciaForm: AssistenciaEsdevenimentComponent;
  ...
  esdevenimentDetall: IEsdevenimentDetallFormModel;
   ...
   */
  async crearPromesaEsdeveniment(): Promise<IEsdevenimentDetallFormModel> {
  ...
  public addGoogleMapScript() {
    ...
    node.src = `https://maps.googleapis.com/maps/api/js?key=${environment.API_GOOGLE_KEY}`;
